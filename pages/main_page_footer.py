...
class MainPageFooter(WebPage):
    ...
    # триггер-элемент скроллинга - Лабиринт в кармане
    scroll = WebElement(
        xpath='//*[@class="b-rfooter-e-section-title b-rfooter-visible-320" and contains(text(),"Лабиринт в кармане")]')
    ...
    #     xpath='//*[@class="b-rfooter-e-logo b-rfooter-e-logo-googleplay analytics-click-js" '
    #           'and contains(text(),"Google Play")]')
    google_play = WebElement(
        xpath='//a[@class="b-rfooter-e-section-title b-rfooter-visible-320" '
    ...
    #     xpath='//a[@class="b-rfooter-e-logo b-rfooter-e-logo-appgallery analytics-click-js" '
    #           'and contains(text(),"App Gallery")]')
    app_gallery = WebElement(
        xpath='//a[@class="b-rfooter-e-section-title b-rfooter-visible-320" '
